...
$Repo = "khanalsaroj/gitreport"
$InstallDir = "$env:USERPROFILE\.gitreport\bin"

Write-Host "Installing gitreport for Windows..."
...
$ZipFile = "$env:TEMP\gitreport.zip"
...
Write-Host "Git Report installed successfully!"
Write-Host "Run: gitreport --help"